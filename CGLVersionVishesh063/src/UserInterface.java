...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Board oddBoard= new Board();
	
	private Board evenBoard= new Board();
	...
	**********************************************************************************************/
	...
	public void populateScreen(Pane p) {
		System.out.println("Test case 0");
		StringBuffer sb = new StringBuffer();
		for (int r = 0; r < oddBoard.boardwidth; r++) {
			for (int c = 0; c < oddBoard.boardheight; c++) {
				if (oddBoard.getBoard()[r][c].isLive()) {
	...
	private void loadImageData() {
		System.out.println("Test case loadimage");
		
		try {
			// Your code goes here......
//			File str1 = new File("./test01.txt");
//			Scanner sc = new Scanner(str1);
			oddBoard = new Board(boardSizeWidth, boardSizeHeight, "./test01");
			evenBoard = new Board(boardSizeWidth, boardSizeHeight, "./test01");
			System.out.println("Test case lo");
			
		}
		catch (Exception e)  {
			System.out.println(e);		}
		populateScreen(oddCanvas);
